...
pub struct DcaConfig {
    ...
    pub symbol: String,
    /// Monto en moneda de cotización por compra (ej: 10 USDT)
    pub quote_amount: f64,
    /// Intervalo entre compras en minutos
    pub interval_minutes: u64,
    /// Compra adicional si precio cae X% desde última compra (0 = off)
    pub price_drop_trigger: f64,
    /// Máximo número de órdenes DCA
    pub max_orders: u32,
    /// Take profit en % sobre costo promedio (0 = off)
    pub take_profit_pct: f64,
    /// Stop loss en % bajo costo promedio (0 = off)
    pub stop_loss_pct: f64,
    /// Trailing take profit: vende si precio cae X% desde el máximo con ganancia (0 = off)
